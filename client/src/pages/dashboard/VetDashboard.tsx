...
const VetDashboard: React.FC = () => {
  ...
  return (
    <div className="container-fluid py-4">
      {/* Welcome Section */}
      <div className="bg-primary bg-opacity-10 rounded-4 p-4 p-md-5 shadow-sm mb-5">
        ...
        {!loading && !error && filteredPatients.length > 0 && (
          <ul className="list-group list-group-flush">
            {filteredPatients.map((patient) => (
              <li key={patient._id} className="list-group-item p-0">
                <Link to={`/vet/patients/${patient._id}`} className="text-decoration-none">
                  <div className="p-4 d-flex align-items-center hover-bg-light">
      ...
      <div className="row g-4 mb-4">
        ...
        <div className="col-md-6">
          <div className="card h-100 border-0 shadow-sm rounded-4 bg-primary bg-opacity-10">
            <div className="card-body p-4">
